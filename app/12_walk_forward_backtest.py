...
DATA = "data/processed/model_dataset_weather.csv"
...
print("=" * 60)
print("WALK-FORWARD BACKTEST - RANDOM FOREST")
print("=" * 60)
print("Feature:", len(FEATURES))
print("Giorni test:", TEST_DAYS)
...
results.to_csv("data/processed/walk_forward_results.csv", index=False)

print("\n" + "=" * 60)
print("WALK-FORWARD COMPLETATO")
print("=" * 60)
print("Salvato: data/processed/walk_forward_results.csv")
