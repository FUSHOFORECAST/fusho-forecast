...
OUTPUT_FILE = "data/processed/model_dataset_calendar.csv"

df = pd.read_csv(INPUT_FILE)
df["date"] = pd.to_datetime(df["date"])
df = df.sort_values("date").reset_index(drop=True)

# evita che holiday_name vuoto elimini tutte le righe
...
# pulizia: NON considerare holiday_name per dropna
...
print("MODEL DATASET CALENDAR CREATO")
print("Righe:", len(df))
