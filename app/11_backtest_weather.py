...
print("=" * 60)
print("BACKTEST RANDOM FOREST + METEO")
print("=" * 60)
...
results.to_csv("data/processed/backtest_results_weather.csv", index=False)

print("\n" + "=" * 60)
print("BACKTEST METEO COMPLETATO")
print("=" * 60)
print("File salvato:")
print("data/processed/backtest_results_weather.csv")
