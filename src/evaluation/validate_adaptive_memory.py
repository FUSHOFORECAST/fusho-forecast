...
FORECAST_FILE = "data/processed/forecast_adaptive_memory_days.csv"
REAL_FILE = "data/processed/june_real_totals.csv"
OUTPUT_FILE = "data/processed/june_adaptive_memory_validation.csv"
...
print("=" * 70)
print("VALIDAZIONE ADAPTIVE MEMORY 1-14 GIUGNO 2026")
print("=" * 70)
